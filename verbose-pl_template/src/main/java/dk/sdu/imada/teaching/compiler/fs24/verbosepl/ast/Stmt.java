package dk.sdu.imada.teaching.compiler.fs24.verbosepl.ast;
...
public abstract class Stmt {
    ...
    public static class Var extends Stmt {
        public Var(Token name, Token type, Expr initializer) {
            this.name = name;
            this.type = type;  // Added type to store the variable's type
        ...
        public final Token type;  // Added type token
