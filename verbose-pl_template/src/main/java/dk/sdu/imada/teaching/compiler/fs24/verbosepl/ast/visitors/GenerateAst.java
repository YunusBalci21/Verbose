...
public class GenerateAst {
    ...
    private static void defineAst(
        String outputDir, String baseName, List<String> types) throws IOException {
            ...
            writer.println("package dk.sdu.imada.teaching.compiler.fs24.verbosepl.ast.visitors;");
            writer.println();
            writer.println("import dk.sdu.imada.teaching.compiler.fs24.verbosepl.scan.Token;");
